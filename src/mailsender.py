...
RECEIVER_ADRESS = ['challengedeepcs@gmail.com', "antoine.pagneux@student-cs.fr", "matthieu.briet@student-cs.fr", "tanguy.colleville@student-cs.fr"]


def send_csv_by_mail(outputs_path : str = OUTPUT_PATH ,sender_adress : str = SENDER_ADRESS, password : str = SENDER_PASSWORD, receiver_adresses : list = RECEIVER_ADRESS):
    ...
    for receiver_adress in receiver_adresses:
        ...
        for file in files:
            ...
            payload.add_header('Content-Decomposition', "attachment; filename= %s" % basename(file))
